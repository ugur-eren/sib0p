...
const Languages: Types.Languages = {
	tr: {
		...
		months_ago: ' ay önce',
		years_ago: ' yıl önce',
		seconds_no_ago: ' saniye',
		minutes_no_ago: ' dakika',
		hours_no_ago: ' saat',
		days_no_ago: ' gün',
		weeks_no_ago: ' hafta',
		months_no_ago: ' ay',
	...
	en: {
		...
		years_ago: ' years ago',
		seconds_no_ago: ' seconds',
		minutes_no_ago: ' minutes',
		hours_no_ago: ' hours',
		days_no_ago: ' days',
		weeks_no_ago: ' weeks',
		months_no_ago: ' months',
		years_no_ago: ' years',
	...
	ru: {
		...
		share_text: 'Я думаю, вам понравится этот пост, который я увидел в sib0p: ',
		share: 'Поделиться',
		report: 'Пожаловаться',
		delete: 'Удалить',
		cancel: 'Отмена',
		...
		delete_dialog: 'Вы уверены, что хотите удалить этот пост? Это действие не может быть отменено.',
		no_post_error: 'Пост не найден и, возможно, было удален..',
		...
		post_auth_error: 'Только автор публикации, может удалить этот пост.',
		report_success: 'Ваша жалоба было успешно отправлена. Наши модераторы рассмотрят ваш запрос в кратчайшие сроки. Тип отчета: ',
		...
		post_share_error: 'При публикации вашего поста возникла неизвестная проблема. Пожалуйста, попробуйте позже.',
		...
		wrong_username: 'Убедитесь, что ваше имя пользователя состоит только из английских символов, цифр, точек и тире.',
		...
		password: 'Пароль',
		password_again: 'Подтверждение пароля',
		login: 'Войти',
		...
		years_ago: ' год назад',
		seconds_no_ago: ' секунды',
		minutes_no_ago: ' минуту',
		hours_no_ago: ' несколько часов',
		days_no_ago: ' дней',
		weeks_no_ago: ' недель',
		months_no_ago: ' месяц',
		years_no_ago: ' год',
		no_post_data: 'Не удалось отправить информацию. Пожалуйста, попробуйте позже.',
		same_comment_error: 'Вы уже комментировали этот пост раньше.',
		comment_auth_error: 'Только автор комментария, может удалить этот комментарий.',
		...
		notif_liked_post: 'понравился ваш пост',
		notif_tagged_on_comment: 'отметил вас в комментарии',
		notif_tagged_on_post: 'отметил вас в посте',
		notif_unfollow: 'отписался от вас',
		notif_warning: 'Вы получили предупреждение: ',
		no_notifs: 'У вас не было непрочитанных уведомлений за последние 3 дня.',
		no_follows: 'Этот пользователь ни на кого не подписан.',
		no_followers: 'У этого пользователя нет подписчиков.',
		search: 'Поиск',
		...
		new_password_again: 'Подтверждение Нового Пароля',
		...
		theme_light: 'Светлый',
		theme_dark: 'Темный',
		theme_timed: 'В зависимости от времени',
		...
		must_choose: 'Вы должны выбрать файл или написать сообщение.',
		...
		spam: 'Спам',
		abusive: 'Оскорбления',
		objectionable: 'Нежелательный контент',
	...
	de: {
		...
		weeks_no_ago: ' vor wochen',
		months_no_ago: ' vor monaten',
		years_no_ago: ' vor jahren',
